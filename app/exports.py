...
def pdfGen(month,year,fundvalue,interestClass,donation,spending,recapital,distribution,operatingDistribution,additionalContribution,timeframe):
	...
	textobject.textLine(text = text)
	text = 'Office of UWA. The results were generated automatically based on the variables inputted below. Previous '
	textobject.textLine(text = text)
	text = 'results can be accessed including this one can be accessed from Stored results portal of the Online Tool.'
	textobject.textLine(text = text)
	textobject.textLine()
